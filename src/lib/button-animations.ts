...
export const buttonAnimations = {
  ...
  hover: "transition-all duration-200 transform hover:scale-105 active:scale-95 hover:shadow-md",
  
  // Pulse animation for important actions
  pulse: "transition-all duration-200 transform hover:scale-105 active:scale-95 hover:shadow-md animate-pulse",
  
  // Bounce animation for playful interactions
  bounce: "transition-all duration-200 transform hover:scale-105 active:scale-95 hover:shadow-md hover:animate-bounce",
  
  // Rotate animation for toggle buttons
  rotate: "transition-all duration-200 transform hover:rotate-12 hover:scale-105 active:scale-95 hover:shadow-md",
  
  // Slide animation for modal/drawer triggers
  slide: "transition-all duration-200 transform hover:translate-x-1 hover:scale-105 active:scale-95 hover:shadow-md",
  ...
  subtle: "transition-all duration-200 transform hover:scale-102 active:scale-95 hover:shadow-sm",
  
  // Icon button animations
  iconButton: "transition-all duration-200 transform hover:scale-110 active:scale-95 hover:shadow-md",
  
  // Destructive action animation
  destructive: "transition-all duration-200 transform hover:scale-105 active:scale-95 hover:shadow-lg hover:shadow-destructive/25",
...
export const buttonPresets = {
  ...
  destructive: combineAnimations(buttonAnimations.hover, buttonAnimations.destructive),
