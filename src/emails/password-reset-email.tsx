...
export const PasswordResetEmail = ({
  ...
  <Html>
    <Head />
    <Preview>
      Your GOAT Mastermind password reset code is {resetCode}
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            We received a request to reset your password for your GOAT Mastermind account. 
          ...
          <Section style={instructionsBox}>
            ...
            <ul style={list}>
              <li style={listItem}>This code will expire in <strong>{validMinutes} minutes</strong></li>
              <li style={listItem}>You can request up to 2 additional codes if needed</li>
              <li style={listItem}>If you didn't request this reset, please ignore this email</li>
              <li style={listItem}>For security, never share this code with anyone</li>
            </ul>
          </Section>

          <Text style={paragraph}>
            Simply enter this code in the verification screen to proceed with resetting your password.
          </Text>
