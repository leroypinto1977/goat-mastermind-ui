      ...
      <Container style={container}>
        ...
        <Section style={header}>
          ...
          <Text style={headerSubtitle}>
            Welcome to the ultimate productivity platform
          </Text>
        </Section>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            Congratulations! Your GOAT Mastermind account has been created
            successfully. You now have access to our powerful platform designed
            to help you achieve your goals and maximize productivity.
          </Text>
          ...
          <Section style={securityBox}>
            ...
            <ul style={list}>
              <li style={listItem}>
                This is a <strong>temporary password</strong> for your first
                login
              </li>
              <li style={listItem}>
